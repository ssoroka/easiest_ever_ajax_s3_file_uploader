require 'easiest_ever_ajax_s3_file_uploader/d2s3/patch/integer'
require 'easiest_ever_ajax_s3_file_uploader/d2s3/signature'
require 'easiest_ever_ajax_s3_file_uploader/d2s3/s3_config'
require 'easiest_ever_ajax_s3_file_uploader/d2s3/view_helpers'

D2S3::S3Config.load_config unless Rails.env.test?
